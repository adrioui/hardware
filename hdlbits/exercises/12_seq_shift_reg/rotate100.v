...
// register, unlike a shifter that discards the shifted-out bit and shifts in a
// zero. If enabled, a rotator rotates the bits around and does not
// modify/discard them.
//
