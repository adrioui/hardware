...
// output [3:0] sum );
//
// Instantiate 4 copies of `bcd_fadd` to create a 4-digit BCD ripple-carry
// adder. Your adder should add two 4-digit BCD numbers (packed into 16-bit
// vectors) and a carry-in to produce a 4-digit sum and carry out.
//
// ──────────────────────────────────────────────────────────────────────────
// HINT:
