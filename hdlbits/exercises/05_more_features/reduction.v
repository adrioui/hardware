...
// ==========================================================================
//
// You're already familiar with bitwise operations between two values, e.g., `a
// & b` or `a ^ b`. Sometimes, you want to create a wide gate that operates on
// all of the bits of *one* vector, like `(a[0] & a[1] & a[2] & a[3] ... )`,
...
// compute a parity bit for a 8-bit byte (which will add a 9th bit to the
// byte). We will use "even" parity, where the parity bit is just the XOR of
// all 8 data bits.
//
// **
