...
- [x] **2.7** Implement `useParser` hook (`src/hooks/useParser.ts`) — debounced parsing
  - reads: `specs/phase2-hierarchy-viz.md`
  - runs: `npx tsc --noEmit`
  - validates: no type errors
...
- [x] **3.2** Implement split-pane layout in App.tsx — left panel (editor + toolbar), right panel (diagram)
