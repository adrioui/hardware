...
- [ ] **2.1** Implement parser → ELK converter (`src/core/converter.ts`) — ParsedDesign to ELK JSON graph
...
- [ ] **2.4** Implement custom ModuleNode component (`src/components/ModuleNode.tsx`)
  - reads: `specs/phase2-hierarchy-viz.md`
  - runs: `npx tsc --noEmit`
  - validates: no type errors

- [ ] **2.5** Implement custom WireEdge component (`src/components/WireEdge.tsx`)
  - reads: `specs/phase2-hierarchy-viz.md`
  - runs: `npx tsc --noEmit`
  - validates: no type errors
